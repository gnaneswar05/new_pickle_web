...
export default function AboutPage() {
  ...
  return (
    <div style={{ fontFamily: 'Fraunces, serif', color: 'var(--text-main)' }}>
      {/* Hero Section */}
      <section style={{ background: 'var(--surface)', borderBottom: '1px solid var(--border)', padding: '120px 20px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, opacity: 0.1, background: 'radial-gradient(circle at center, var(--primary) 0%, transparent 70%)' }}></div>
        <div style={{ maxWidth: '800px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <h1 style={{ fontSize: 'clamp(3rem, 8vw, 4.5rem)', fontWeight: '900', fontFamily: 'Fraunces, serif', marginBottom: '20px', color: 'var(--text-main)' }}>Our <span style={{ color: 'var(--primary)' }}>Story</span></h1>
          <p style={{ fontSize: '1.25rem', color: 'var(--text-muted)', lineHeight: 1.6 }}>Bringing the authentic, sun-dried flavors of the Godavari delta to the global stage.</p>
        </div>
      </section>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '100px 20px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '80px', alignItems: 'center' }}>
          <div>
            ...
            <h2 style={{ fontSize: '2.5rem', fontWeight: '900', color: 'var(--text-main)', marginBottom: '30px', fontFamily: 'Fraunces, serif' }}>Handcrafted with Love for Generations</h2>
          ...
          <div style={{ background: 'var(--surface)', padding: '60px', borderRadius: '50px', border: '1px solid var(--border)' }}>
            ...
            <h3 style={{ fontSize: '2rem', fontWeight: '900', color: 'var(--text-main)', marginBottom: '20px', fontFamily: 'Fraunces, serif' }}>Taste the Tradition</h3>
            <p style={{ fontSize: '1.05rem', lineHeight: 1.7, color: 'var(--text-muted)', marginBottom: '30px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: 'var(--text-main)', fontWeight: '700' }}>
                <ShieldCheck size={20} color="var(--primary)" /> 100% Pure & Preservative Free
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: 'var(--text-main)', fontWeight: '700' }}>
                <Leaf size={20} color="var(--primary)" /> Sustainably Sourced Ingredients
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: 'var(--text-main)', fontWeight: '700' }}>
                <Award size={20} color="var(--primary)" /> Traditional Stone-Ground Spices
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Why Choose Us */}
      <section style={{ background: 'var(--background)', borderTop: '1px solid var(--border)', padding: '100px 20px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: '900', fontFamily: 'Fraunces, serif', color: 'var(--text-main)' }}>Why Pickle Lovers <span style={{ color: 'var(--primary)' }}>Trust Us</span></h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
            {(trustFeatures && trustFeatures.length > 0 ? trustFeatures : [
              ...
              return (
                <div key={i} style={{ background: 'var(--surface)', padding: '40px', borderRadius: '32px', textAlign: 'center', border: '1px solid var(--border)', boxShadow: 'var(--shadow)' }}>
                  <div style={{ width: '64px', height: '64px', background: 'var(--secondary)', color: 'var(--primary)', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 25px' }}>
                    <IconComponent size={30} />
                  </div>
                  <h4 style={{ fontSize: '1.25rem', fontWeight: '800', marginBottom: '15px', color: 'var(--text-main)' }}>{item.title}</h4>
