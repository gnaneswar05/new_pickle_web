  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '3rem' }}>
        <div style={{ width: '3rem', height: '3rem', background: '#ecfdf5', color: '#059669', borderRadius: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {messages.length === 0 ? (
          ...
          messages.map((m: any) => (
            <div key={m._id} style={{ background: 'white', padding: '30px', borderRadius: '32px', border: '1px solid #f1f5f9', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.02)' }}>
              ...
              <div>
                <h4 style={{ fontSize: '0.75rem', fontWeight: '900', color: '#059669', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '8px' }}>Subject: {m.subject}</h4>
